...
# Merge and Reverse algorithm for CPT2-1(Type 2-1 Construction Procedure)
def MR_T2_1(order_0, I0):
    # Fixed alternatives
    i1 = I0[0]
    i2 = I0[1]
...
# CPT2-1 algorithm; Inputs- n: number of objects, N_hat: fixed alternatives
def CPT2_1(n, N_hat):
    ...
    # Perform M&R: Line 13
    S1, orders1, X1 = MR_T2_1(S0.bucs, [i1, i2])
...
# T2-1 FDI proof
def T2_1_Solution_Matrix_Operations(mat, n, N_hat):
    i1 = sorted(N_hat)[0]
    i2 = sorted(N_hat)[1]
    ...
    # Eliminate the first two nonzero entries of row 2n(i-1)-i^2+2
    for i in range(1, n - 2 + 1):
...
n = 8
N_hat = [1, n]
X, orders = CPT2_1(n, N_hat)

print("The weak orders output by the CPT2-1 algorithm for n=" + str(n) + " are given below: ")
...
T2_1_Solution_Matrix_Operations(X, n, N_hat)
